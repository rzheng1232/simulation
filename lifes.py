...
# array_colors = [[0 for j in range(WIDTH)] for i in range(HEIGHT)]
# BG_COLOR = (0, 0, 0)  # Background color
# POINT_COLOR = (0, 0, 255)  # Point color
# init_pixel = (300, 300)
# array_colors[init_pixel[0]][init_pixel[1]] = 1
# def check_proximity(curr_pos):
#     total = 0
#     if array_colors[curr_pos[0]+1][curr_pos[1]] != 0:
#         total+=1
#     if array_colors[curr_pos[0]-1][curr_pos[1]] != 0:
#         total+=1
#     if array_colors[curr_pos[0]][curr_pos[1]-1] != 0:
#         total+=1
#     if array_colors[curr_pos[0]][curr_pos[1]+1] != 0:
#         total+=1
#     return total
...
#         if array_colors[pos[0]][pos[1]] == 0:
#             array_colors[pos[0]][pos[1]] = 1
#     else:
#         if array_colors[pos[0]][pos[1]] != 0:
#             array_colors[pos[0]][pos[1]] = 0

# def iterate_function():
#     for i in range(array_colors):
#         for j in range(array_colors[i]):
#             if array_colors[i][j] != 0:
#                 total_proximity = check_proximity((i, j))
#                 # Rules
#                 # if no other pixels around, 100% chance of activating at least one other pixel
...
#                 # if 1 pixel around, 75% creation new pixel 25% chance of just dying
#                 # if 2 pixel around, 50/50
#                 # if 3 pixel, 25, 75
#                 # if 4 pixel, die automtically
