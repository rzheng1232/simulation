...
def initialize_population(color, amount, space_w, space_h):
    ...
    for i in range(amount):
        ...
        objects_init_position.append([random.randint(space_w[0], space_w[1]-1), random.randint(space_h[0], space_h[1]-1), 0, 0])
            ...
            for other_color, other_particles in objects_array.items():
                for j, particle2 in enumerate(other_particles):
                    ...
                    if distance < repulsion_distance:
                        ...
                        force_strength = 100 / (distance**2 + 0.1)  # Small constant to avoid division by zero
...
initialize_population("color_1", 200, (0, WIDTH-600), (0, HEIGHT-600))
initialize_population("color_3", 150, (WIDTH-600, WIDTH), (0, HEIGHT-600))
initialize_population("color_7", 175, (WIDTH-600, WIDTH), (HEIGHT-600, HEIGHT))
initialize_population("color_10", 105, (0, WIDTH-600), (HEIGHT-600, HEIGHT))

running = True
rules = [
        ("color_3", "color_3", random.random() * 2 - 1),
        ("color_3", "color_7", random.random() * 2 - 1),
        ("color_3", "color_1", random.random() * 2 - 1),
        ("color_3", "color_10", random.random() * 2 - 1),
        ("color_1", "color_1", random.random() * 2 - 1), 
        ("color_1", "color_3", random.random() * 2 - 1),
        ("color_1", "color_7", random.random() * 2 - 1),
        ("color_1", "color_10", random.random() * 2 - 1),
        ("color_7", "color_3", random.random() * 2 - 1),
        ("color_7", "color_1", random.random() * 2 - 1),
        ("color_7", "color_10", random.random() * 2 - 1),
        ("color_7", "color_7", random.random() * 2 - 1),
        ("color_10", "color_7", random.random() * 2 - 1),
        ("color_10", "color_3", random.random() * 2 - 1),
        ("color_10", "color_1", random.random() * 2 - 1),
        ("color_10", "color_10", random.random() * 2 - 1)
