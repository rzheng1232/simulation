...
WIDTH_screen, HEIGHT_screen = 1200, 1200  # Screen dimensions
...
# initialize_population("color_1", 200, (0, WIDTH-300+150), (0, HEIGHT-300+150))
# initialize_population("color_3", 200, (WIDTH-300+150, WIDTH), (0, HEIGHT-300+150))
# initialize_population("color_7", 200, (WIDTH-300+150, WIDTH), (HEIGHT-300 +150, HEIGHT))
# initialize_population("color_10", 200, (0, WIDTH-300+150), (HEIGHT-300+150, HEIGHT))
initialize_population("color_1", 200, (0, WIDTH), (0, HEIGHT))
initialize_population("color_3", 200, (0, WIDTH), (0, HEIGHT))
initialize_population("color_7", 200, (0, WIDTH), (0, HEIGHT))
initialize_population("color_10", 200, (0, WIDTH), (0, HEIGHT))
running = True
rules = [
        ("color_3", "color_3", -0.5),
        ("color_3", "color_7", -0.7),
        ...
        ("color_1", "color_1", -0.5), 
        ("color_1", "color_3", -0.7),
        ("color_1", "color_10",0.7),
        ("color_7", "color_3", 0.7),
        ("color_7", "color_10", -0.7),
        ("color_7", "color_7", -0.5),
        ("color_10", "color_7", 0.7),
        ("color_10", "color_1", -0.7),
        ("color_10", "color_10", -0.5)
