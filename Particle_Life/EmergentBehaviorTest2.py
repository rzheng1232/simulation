    ...
    for rule in rule_array:
        ...
        for i, particle1 in enumerate(color1_particles):
            ...
            for j, particle2 in enumerate(color2_particles):
                ...
                if (distance > 15 and distance < 80):
                    g = rule[2]
                    fx += g * dx
                    fy += g * dy
...
points_r = initialize_population("red", 200, WIDTH-200, HEIGHT-200)
#points_b = initialize_population("blue", 200, WIDTH-200, HEIGHT-200)
points_g = initialize_population("green", 200, WIDTH-200, HEIGHT-200)
running = True
while running:
